...
class DatasetMarcoPassagesRanking(Dataset):
    ...
    MSMARCO_PASSAGE_TRAIN_QRELS_FILENAME = "passage_ranking/qrels.train.tsv"
    MSMARCO_PASSAGE_TRAIN_QUERY_FILENAME = "passage_ranking/train.query.txt"
    ...
    def __init__(
        ...
        if load_type == "disk":
            ...
            self.collection_pid_list = list(self.collection_pid2text.keys())
